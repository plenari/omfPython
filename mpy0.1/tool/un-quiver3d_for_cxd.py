...
f=r'C:\Users\omf\Desktop\mpy\N16-NZ64-T50-t0.2-kk-dd-kk0.0-dd1.2\t\out1.dat'
...
def ana(fpath):#总的分析
    ...
    if file_suffix=='dat':
        x,y,z,mx,my,mz=read_dat(fpath,img_ratio,clip_xyz,clip_ms,model_shape,Ms)
    if len(x)>0:
...
if __name__=='__main_':
    ...
    # 其他，按需更改
    file_suffix='dat'#or 'txt’.chose which kind of text
